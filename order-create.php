...
require 'config/function.php';
    ...
    $finalPrice = ((($difference * $pricePerHour) + $convenienceFee) + $totalinsurance);

    if(isset($_POST['razorpay_btn']))
    {

        $data = array('amount' => $finalPrice, 'currency' => "USD");                                                                    
    ...
    if(isset($_POST['payment_success'])){
        if(isset($_POST['payment_id']) && $_POST['payment_id'] != ""){
            ...
            $totalPrice = (($difference * $pricePerHour) + $convenienceFee) + $totalinsurance;
