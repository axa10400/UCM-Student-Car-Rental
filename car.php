                ...
                <div class="col-md-4">
                    <div class="car-card sticky2">
                        ...
                        ?>
                            ...
                            <h5 class="title1 fs-16 mb-1">Per Day <span class="float-end">$ <?=$car['price_per_hour'];?>/day</span></h5>
                            <h5 class="title1 fs-16 mb-1">Convenience Fee <span class="float-end">$ 10</span></h5>
                            <?php 
                                ...
                                $difference = abs($endtimestamp - $starttimestamp)/ (24 * 60 * 60);;

                                $insurance = 140;
                                $insurancePerHour = $insurance/24;
                                $totalinsurance = $insurancePerHour*$difference;
                                
                                $convenienceFee = 10;
                            ?>
                            <h5 class="title1 fs-16 mb-1">Insurance Fee<span class="float-end">$ <?= round($insurancePerHour,2); ?></span></h5>
                            ...
                            if (isset($_SESSION['loggedInUser'])) {
                                    ...
                                    if (str_contains($user['data']['email'], '@ucm.edu')) { 
                                    
                                        $total = ($difference * $car['price_per_hour']) + $convenienceFee + $totalinsurance;
                                        $discountprice = ($total / 100) * 15;
                                        
                                    }
                                    if(isset($discountprice)){
                                    echo '<h5 class="title1 fs-16 mb-1">Student Disscount(15% off) <span class="float-end">'.$discountprice.' </span></h5>';
                                    }
                                }
                            ?>
                            <h5 class="title1 mb-1">Total Price <span class="float-end"> $ <?= ($difference * $car['price_per_hour']) + $convenienceFee + $totalinsurance - (isset($discountprice) ? $discountprice : 0); ?></span></h5>
