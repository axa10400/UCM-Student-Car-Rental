...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $pageName == "bookings_issue.php"?'active':'' ?>"  href="bookings_issue.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-list <?= $pageName == "bookings_issue.php"?'text-white':'text-dark' ?>   text-lg"></i>
            </div>
            <span class="nav-link-text ms-1">Booking Issue</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  <?= $pageName == "feedbacks.php"?'active':'' ?>"  href="feedbacks.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa fa-list <?= $pageName == "feedbacks.php"?'text-white':'text-dark' ?>   text-lg"></i>
            </div>
            <span class="nav-link-text ms-1">Booking Feedbacks</span>
          </a>
        </li>
        <li class="nav-item">
