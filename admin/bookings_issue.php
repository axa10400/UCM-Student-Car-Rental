                ...
                <div class="card-body pt-0 pb-2">
                    ...
                    <?php
                        ...
                        $query = "SELECT b.*, b.id as booking_id, u.name as username, c.image, c.name as car_name 
                                FROM bookings b, users u, cars c WHERE booking_status = 'live' AND booking_issue IS NOT NULL
                                AND b.car_id=c.id AND b.user_id=u.id  ORDER BY b.start_date";
                                    ...
                                    <table id="myTable" class="table table-striped align-items-center justify-content-center">
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $bookingsItem['booking_issue']; ?></td>
                                                <td>
