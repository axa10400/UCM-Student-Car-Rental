    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="col-md-12 my-3">
                <div class="card shadow rounded-4 mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <?php if($booking['Feedback'] != NULL) { ?>
                            <div class="col-md-12">
                                <p class="title-sm fs-14 mb-1"> Booking Feedback: <span class="text-dark fw-bold"> <?=$booking['Feedback'];?></span> </p>
                            </div>
                            <?php } ?>
                            <hr class="bg-dark">
                            <div class="col-md-12">
                ...
                <?php if($booking['booking_issue'] != NULL) { ?>
                    <div class="card shadow rounded-4 mb-3">
                        <div class="card-header">
                            <h5 class="mb-0">Slove Issue</h5>
                        </div>
                        <div class="card-body">
                            <form action="code.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="mb-1">Booking Issue: </label>
                                        <p><?=$booking['booking_issue'];?></p>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="mb-1"> Select the status: </label>
                                        <select name="issue_status" class="form-select" required>
                                            <option value="">select options</option>
                                            <option <?= $booking['issue_status'] == '0'?'selected':'' ?> value="0">Issue Pending</option>
                                            <option <?= $booking['issue_status'] == '1'?'selected':'' ?> value="1">We will working on it</option>
                                            <option <?= $booking['issue_status'] == '2'?'selected':'' ?> value="2">Issue solved</option>  
                                        </select>
                                    </div>
                                    
                                    <div class="col-md-6 text-end">
                                        <br/>
                                        <button type="submit" name="update_issue_btn" class="btn btn-primary">Submit</button>
                                    </div>
                                </div>
