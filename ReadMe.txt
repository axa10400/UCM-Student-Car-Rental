...
6. Import the file, "car_rental.sql" file using the admin panel, all the required database creation and table creation is in the script
7. Place the folder that has all the project files at this location "C:\xampp\htdocs"
8. Launch the index file, using the php and application will be launced at  - http://localhost/xampp/UCMStudentCarRental/index.php/